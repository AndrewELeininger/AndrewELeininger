...
function play(Number) {
  scrollup();
  const summaries = [  
  "The sole survivor of a shipwreck has been stranded on a strange, unknown island where the only food he has to eat is small pink flowers, and the only friend he has is a magical floating fish. Every day as the sun begins to set, he must hide himself, and the fish, to avoid the dangers of the night, but he can't hide forever and soon he will have to face his fears and risk everything for a chance of freedom.<b><br><br>Time Approx. 7 Minuutes<br><br>Directed by Andrew Leinger<br> ToastMan2020<b>",
  "Lord Alister and his ragtag band of rebellious knights have received word that their old friend, Lord Jerome, will be passing through the outer borders, carrying a very valuable piece of cargo. Unable to pass up such an opportunity, they devise a plan to intercept him, but it may not be as simple as they hope.<b><br><br>Time Approx. 7 Minuutes<br><br>Directed by Andrew Leinger<br>Starring Peter Leininger<br> ToastMan2022<b>",
  "Deep in the forests, high in the hills, in legends lost to time, there lives a creature, half man and half bird. Of his strength all are afraid, all but one, one man, one king.<b><br><br>Time Approx. 3 Minuutes<br><br>Directed by Andrew Leinger<br> ToastMan2023<b>",
  "After years living inside the walls of a shady institution, Patient Zero has formed a plan is getting ready to act on it. This plan may prove perilous, but no risk is too great for the chance of escape.<b><br><br>Time Approx. 4 Minuutes<br><br>Directed by Andrew Leinger<br>Music by Jacob Ryman<br> ToastMan2024<b>",
  ];
